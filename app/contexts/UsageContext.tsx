...
// this file is responsible for managing the usage data of the user, including their current plan, subscription status,
//  and usage of meetings and chat messages.
//  It provides a context that can be used throughout the app to access this data and perform actions like incrementing usage or refreshing the data.
// The PLAN_LIMITS object defines the limits for each plan, which can be used to determine if the user can perform certain actions based on their current usage and subscription status.
// The UsageProvider component fetches the usage data when the user is loaded and provides functions to increment usage and refresh the data.
//  The useUsage hook allows other components to easily access this context.